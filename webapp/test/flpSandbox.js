		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Material App for Cross app Nav",
									"targetURL": "#zcrossmaterial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcrossmaterial-display": {
								"semanticObject": "zcrossmaterial",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcrossmaterial",
									"url": sap.ui.require.toUrl("zcrossmaterial")
								}
							}
						}
					}
